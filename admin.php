...
<html>
 ...
 <table style="width:100%;">
  <tr>
   <th colspan="2">Usuarios registrados<a href="users.php?action=add">[AGREGAR USER]</a></th>
  </tr>
<?php
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo $row['nombre'];
    echo '</td><td>';
    echo ' <a href="users.php?action=edit&id=' . $row['id_alumno'] . '"> [EDITAR USUARIO]</a>'; 
    echo ' <a href="delete.php?type=movie&id=' . $row['id_alumno'] . '"> [BORAR USUARIO]</a>';
    echo '</td></tr>';
}
?>
  <tr>
    <th colspan="2">Emociones registradas<a href="emotions.php?action=add"> [AGREGAR EMOCIÓN]</a></th>
  </tr>
<?php
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo $row['comentario'];
    echo '</td><td>';
    echo ' <a href="emotions.php?action=edit&id=' . $row['id_emocion'] .
        '"> [EDITAR EMOCIÓN]</a>'; 
